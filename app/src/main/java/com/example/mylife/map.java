...
public class map extends
    ...
    private static String EXTRA_SESSION_ID = "EXTRA_SESSION_ID";
    ...
    public void set(View view) {
        ...
        values.put(DBContractFriends.NoteColumns.Latitude, mLat);
        values.put(DBContractFriends.NoteColumns.Longitude, mLong);
        dbWrite.update(DBContractFriends.TABLE_NAME, values,  " id_friends = ?", new String[] {sessionId});
        Toast.makeText(map.this, "Location has updated", Toast.LENGTH_SHORT).show();
